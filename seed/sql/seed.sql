...
INSERT INTO
  invoice
(year,month,number,invoice_nr, type, create_date, execution_end_date, netto_value, brutto_value, status, url, company_dealer, company_recipent, person_dealer, person_recipent ) VALUES
  (2012,2,2,'FV/12/02/02','buy' , '2012-02-08', '2012-02-15', 230.45,345.89, 'unpaid', 'url1',1,2,null,null),
  (2012,4,2,'FV/12/04/02' ,'sell' , '2012-04-08',  '2012-04-15', 330.45,475.89, 'paid', 'url2',2,1,null,null),
  (2013,7,12,'FV/13/07/12' ,'sell', '2013-07-02',  '2013-07-15', 1230.45,1445.89, 'unpaid', 'url3',null,2,1,null),
