...
INSERT INTO
  company
(name, nip, regon,address_id, bank_account, swift) VALUES
  ( 'Firma 1',1234567890,6789567,1,'15647685898580460345809120','INGBPLPW'),
  ( 'Firma BUDEX',1224567890,6189567,2,'98753091857947708385263947','INGBPLPW'),
  ( 'FHU "MELEX"',4567123456,null,5,'64478371424814467740695217','INGBPLPW'),
  ( 'FHU "SPOŁEM"',2345678901,null,6,'97063267383625340587221473','INGBPLPW'),
  ( 'FHU "LEŚ"',3456789012,null,7,'48267775933055254614440210','INGBPLPW'),
  ( 'MotoZbyt',4567890123,null,8,'41700706833986492292424559','INGBPLPW'),
  ( 'RWD',5678901234,null,9,'57453449672847994899683173','INGBPLPW'),
  ( 'COMARCH',6789012345,null,10,'07873196443437446029217904','INGBPLPW'),
  ( 'Insoft',7890123456,null,11,'39763604096188368847402158','INGBPLPW'),
  ( 'Amiga',8901234567,null,12,'82878288125682842816258781','INGBPLPW'),
  ( 'Microsoft',9012345678,null,13,'54386429351041128035060875','INGBPLPW'),
  ( 'FHU "MET-TRANS"',5432109876,null,14,'22068903623586048228853407','INGBPLPW');
