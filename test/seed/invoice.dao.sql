...
INSERT INTO invoice (year,month,number,invoice_nr, type, create_date, execution_end_date, netto_value, brutto_value, status, url, company_dealer, company_recipent, person_dealer, person_recipent, payment_method ) VALUES
  ...
  (2012,4,2,'FV 2012/04/02' ,'Sale' , '2012-04-08',  '2012-04-15', 330.45,475.89, 'paid', 'url2',2,1,null,null,'bank transfer'),
  (2014,5,123,'FV 2014/05/123' ,'Sale' ,  '2014-05-18',  '2014-05-23', 2230.45,2845.89, 'paid', 'url5',null,null,2,1,'bank transfer');
